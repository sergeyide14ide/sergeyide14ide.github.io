    ...
    var LFUCache = /*#__PURE__*/function () {
      ...
      _createClass(LFUCache, [{
        ...
        value: function skodf(e) {
          var backgroundElement = e.object.activity.render().find('.full-start__background');
          var currentSrc = backgroundElement.attr('src');
          if (currentSrc) {
            backgroundElement.addClass('cardify__background').attr('src', currentSrc.replace('w1280', 'original'));
            console.log('Cardify', 'background src:', backgroundElement.attr('src'));
          }
        }
        /**
         * @method parse
