    ...
    function addSettings() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function(item) {
                ...
                item.append('<div style="color: rgba(255,255,255,0.3); font-size: 0.9em; padding: 0 1.2em; line-height: 1.4;">Автор: DarkestClouds<br>Делает интерфейс в карточке фильма похожим на Apple TV и оптимизирует под 4K</div>');
            }
        });
